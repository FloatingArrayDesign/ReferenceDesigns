...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT-TLP_ElastoDyn.dat"    EDFile         - Name of file containing ElastoDyn input parameters (quoted string)
...
"InflowWindFile-TLP.dat" InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"IEA-15-240-RWT/IEA-15-240-RWT-UMaineSemi_AeroDyn15.dat"   AeroFile        - Name of file containing aerodynamic input parameters (quoted string) 
"IEA-15-240-RWT/IEA-15-240-RWT-UMaineSemi_ServoDyn_operating.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"IEA-15-240-RWT-TLP_SeaState.dat"    SeaStFile   - Name of file containing sea state input parameters (quoted string)
"IEA-15-240-RWT-TLP_HydroDyn.dat"   HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"unused"                 SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"MoorDyn-TLP.dat"              MooringFile     - Name of file containing mooring system input parameters (quoted string) 
